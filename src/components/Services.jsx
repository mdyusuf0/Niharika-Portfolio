...
const Services = () => {
  ...
  const pathD = "M 700,100 C 450,200 200,300 300,450 C 400,600 750,550 700,750 C 650,950 200,900 300,1050 C 400,1200 700,1250 650,1350 C 600,1450 400,1450 300,1500";
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1650px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          {skillsContent.cards.map((card, index) => {
            const positions = [
              ...
              "md:absolute md:top-[350px] md:left-[5%] lg:left-[10%] -rotate-2 md:-rotate-6",
              "md:absolute md:top-[700px] md:right-[5%] lg:right-[15%] rotate-1 md:rotate-3",
              "md:absolute md:top-[1050px] md:left-[5%] lg:left-[15%] -rotate-1 md:-rotate-3",
              "md:absolute md:top-[1350px] md:right-[10%] lg:right-[20%] rotate-2 md:rotate-4",
            ];
          ...
          <div 
            data-aos="fade-in" 
            data-aos-delay="600"
            className="hidden md:block absolute top-[1550px] left-[45%] font-['Caveat',cursive] text-3xl text-gray-600 rotate-6"
          >
